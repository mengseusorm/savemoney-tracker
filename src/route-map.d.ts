...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/login': RouteRecordInfo<
      ...
      | never
    >,
    '/reports/compare': RouteRecordInfo<
      '/reports/compare',
      '/reports/compare',
      Record<never, never>,
      Record<never, never>,
      | never
    >,
    '/reports/expenses': RouteRecordInfo<
      '/reports/expenses',
      '/reports/expenses',
      Record<never, never>,
      Record<never, never>,
      | never
    >,
    '/reports/incomes': RouteRecordInfo<
      '/reports/incomes',
      '/reports/incomes',
      Record<never, never>,
      Record<never, never>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/reports/compare.vue': {
      routes:
        | '/reports/compare'
      views:
        | never
    }
    'src/pages/reports/expenses.vue': {
      routes:
        | '/reports/expenses'
      views:
        | never
    }
    'src/pages/reports/incomes.vue': {
      routes:
        | '/reports/incomes'
      views:
        | never
